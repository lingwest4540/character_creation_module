...
def attack(char_name: str, char_class: str) -> str:
    """Описываем сколько каждый класс должен наносить урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Сколько каждый класс должен блокировать урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описываем специальные способности каждого класса."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Пишем описание каждого персонажа при его выборе."""
